...
public class TileManager {
    ...
    private BufferedImage buildImage(BufferedImage[] images) {
     ...
     *
     *
    private BufferedImage getBuildRotImage(BufferedImage[] images, int rotAngle, int rotAtIndex) {
        ...
        for (int i = 0; i < images.length; i++) {
            if (rotAtIndex == i)
                graphics.rotate(Math.toRadians(rotAngle), (double) width / 2, (double) height / 2);
